...
Z_2=rgb.reshape((-1,len(rgb[0][0])))
print(Z_2)
ac_model=AC(n_clusters=10,linkage='average',compute_full_tree='false',affinity='cosine')
ac_labels=ac_model.fit_predict(Z_2)
img_labels_3=ac_labels.reshape((rgb.shape[0],rgb.shape[1]))
#
